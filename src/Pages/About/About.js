...
const About = () => {
  return (
    <div className="py-12 h-screen bg-base-100">
      <div className="px-6 lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 bg-base-100 mx-auto">
      <div className="flex flex-col lg:flex-row justify-between gap-8 lg:container mx-auto">
      ...
      <div className="flex lg:flex-row flex-col justify-between gap-8 pt-12 lg:container mx-auto">
        <div className="w-full lg:w-5/12 flex flex-col justify-center">
          <h1 className="text-3xl lg:text-4xl font-bold leading-9 pb-4">
            Our Story
          </h1>
