  ...
  const navItems = (
    <>
      ...
      <li>
        {user?.email ? (
          <button
            className="btn btn-ghost bg-accent font-bold text-white rounded-xl hover:bg-accent lg:ml-2"
            onClick={logout}
          >
            Sign Out
          </button>
  ...
  return (
    <section className="flex justify-center mb-8">
      <div className="fixed top-0 w-full z-50">
        ...
        <div
          className={`drawer-content flex flex-col h-[72px] backdrop-blur-[18px] bg-base-100/60  ${
        ...
        >
          ...
          <ul className="menu p-4 gap-4 overflow-y-auto w-80 font-bold h-screen backdrop-blur-[18px] bg-base-100/80">
            {navItems}
          </ul>
        </div>
      </div>
